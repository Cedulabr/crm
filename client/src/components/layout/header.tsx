...
import { SyncDialog } from "@/components/data-sync/SyncDialog";
...
export default function Header({ onMobileMenuToggle }: HeaderProps) {
  ...
  return (
    <>
      ...
      {/* Componente de diálogo de sincronização (escondido) */}
      <div className="hidden">
        <SyncDialog trigger={<button id="sync-dialog-trigger" />} />
      </div>
    </>
  );
}
